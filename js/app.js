(() => {
            ...
            var t =
              ...
              e =
                arguments.length > 1 && void 0 !== arguments[1]
                  ? arguments[1]
                  : this.value.length;
            return new q(this.extractInput(t, e), t);
          },
        },
        {
          key: "appendTail",
          value: function (t) {
            return D(t) && (t = new q(String(t))), t.appendTo(this);
          },
        },
        {
          key: "_appendCharRaw",
  ...
  function H(t) {
    ...
    return t instanceof RegExp
      ...
      ? $.MaskedDynamic
      : $.Masked && t.prototype instanceof $.Masked
      ? t
      : t instanceof Function
      ? $.MaskedFunction
      : t instanceof $.Masked
      ? t.constructor
      : (console.warn("Mask not found for mask", t), $.Masked);
  }
  function N(t) {
    if ($.Masked && t instanceof $.Masked) return t;
    var e = (t = Object.assign({}, t)).mask;
    if ($.Masked && e instanceof $.Masked) return e;
    var n = H(e);
    if (!n)
      throw new Error(
            ...
            value: function (t) {
              ...
              if (e === O || e === M) {
                ...
                for (var j = l; j < this._blocks.length; ++j) {
                  var q = this._blocks[j],
                    $ = q.nearestInputPos(0, x);
                  if (!q.value.length || $ !== q.value.length)
  ...
  $.HTMLContenteditableMaskElement = rt;
  var at = ["mask"],
    ut = (function () {
      function t(e, n) {
        f(this, t),
        ...
        g(t, [
          {
            ...
            set: function (t) {
              if (!this.maskEquals(t))
                if (t instanceof $.Masked || this.masked.constructor !== H(t)) {
                  var e = N({ mask: t });
  ...
  new $(document.getElementById("phoneNumber"), { mask: "+{7}(000)000-00-00" });
  ...
  function Bt(t, e, n) {
    ...
    switch (n) {
      ...
      case "logo":
        i.style.backgroundImage =
          "url(https://talinya222.github.io/fitness/img/icons/logo.svg)";
        break;
      case "shadow":
    ...
    i.animate(
      [
        ...
        {
          transform: `translate(-50%, -50%) translate(${t + a}px, ${
            e + u
          }px) rotate(${o}deg)`,
          opacity: 0,
        },
  ...
  document.addEventListener("click", function (t) {
    ...
    document.body.animate &&
      document
        .querySelectorAll(".main-block__button")
        .forEach((t) => t.addEventListener("click", Ft));
  const xt = document.querySelector(".events"),
    Ot = document.querySelector(".wrapper");
  xt &&
    document.addEventListener("watcherCallback", function (t) {
      const e = t.detail.entry;
      "up" === e.target.dataset.watch &&
        innerWidth > 1420 &&
        (e.isIntersecting
          ? Ot.classList.remove("_page-up")
          : Ot.classList.add("_page-up"));
    }),
    (window.FLS = !0),
    (function (t) {
      let e = new Image();
